...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin">
		...
		<spring:bind path="typeOfUser">
            <div class="form-group ${status.error ? 'has-error' : ''}">
            	<form:radiobutton path="typeOfUser" label="Driver" value="Driver"/><br/>	
            	<form:radiobutton path="typeOfUser" label="Sender" value="Sender"/>   
            	<form:errors path="typeOfUser"></form:errors>             
            </div>
        </spring:bind>
